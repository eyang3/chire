            ...
            <v-container fluid>
                <v-slide-y-transition mode="out-in">
                    <v-layout column align-center>
                        <div class="subheader">Update Account</div>
                        ...
                        <v-container fluid>
                            ...
                            <v-layout row>
                                ...
                                <v-flex xs8>
                                    <v-btn color="primary" @click.native="revert" :disabled = "!pass">Save</v-btn>
                                </v-flex>
                            </v-layout>
                        </v-container>>
...
export default {
  ...
  methods: {
    revert: function() {
      axios
        .post("/api/ar/update", { username: this.email, password: this.password })
        .then(response => {
